 ...
 *
 * 확인 전에는 작은 트리거 버튼만 보인다 - 바로 위 저장 버튼(`SubmitButton`,
 * `w-full`)과 폭·위치를 공유하지 않는다. 색만으로 파괴적 동작을 구별하지
 * 않기 위해서다(색각 이상에서 무너지고, 맞붙은 전폭 버튼에서는 그나마의
 * 구별도 조준에 도움이 되지 않는다). 누르면 같은 `<form>` 안에서 확인
 * 문구 + 진짜 제출 버튼으로 바뀐다.
 *
